      REAL*8 FUNCTION STBBB_BBB(LAM1,LAM2,P1, P2, P3, P4)
C  
...
C          IF (GOODHEL(IHEL) .OR. NTRY .LT. 10) THEN
             T=BBB_BBB(LAM1,LAM2,P1, P2, P3, P4,NHEL(1,IHEL)) 
             STBBB_BBB = STBBB_BBB + T
...
C          ENDIF
      ENDDO
      STBBB_BBB = STBBB_BBB /  4D0 
      END
       
       
      REAL*8 FUNCTION BBB_BBB(LAM1,LAM2,P1, P2, P3, P4,NHEL)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT IN PHASE SPACE P1,P2,P3,P4,...
...
c T-CHANNEL GLUON                     
      CALL JIOXXX(W3  ,W2  ,GG,ZERO,ZERO,W6  )                             
      CALL IOVXXX(W4  ,W6  ,W1  ,GG,AMP(2  ))                           
      BBB_BBB = 0.D0 
      DO I = 1, NEIGEN
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NGRAPHS
          ...
          ENDDO
          BBB_BBB =BBB_BBB+ZTEMP*EIGEN_VAL(I)*CONJG(ZTEMP) 
      ENDDO
