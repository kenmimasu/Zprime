...
C constant t and b masses
c       parameter(mc=1.5d0,mb=4.5d0,mt=175.d0)
C         parameter(mc=0.d0,mb=3.2d0,mt=173.d0)
C Account for common top/bottom mass in ffbarMultiZp.f
       parameter(mc=1.5d0)
       mt=rmt
       mb=rmb
       if (mu.lt.mc) then 
