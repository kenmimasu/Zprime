...
C       print*,'m1,w1,gL1,gR1,GL1,GR1=',m_eff(1),w_eff(1),
C      &gi_eff(1,1),gi_eff(2,1),gf_eff(1,1),gf_eff(2,1)
C       print*,'m2,w2,gL2,gR2,GL2,GR2=',m_eff(2),w_eff(2),
C      &gi_eff(1,2),gi_eff(2,2),gf_eff(1,2),gf_eff(2,2)    
C       print*,'m',m
C       print*,'w',w
C       print*,'mbar',mbar
C       print*,'psq',psq
